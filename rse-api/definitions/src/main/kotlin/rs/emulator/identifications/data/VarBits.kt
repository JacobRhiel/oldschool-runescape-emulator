package rs.emulator.identifications.data

import rs.emulator.collections.varbits.VarbitDelegate
...
fun VarbitList.id(varbit: VarBits) : VarbitDelegate {
	return id(varbit.varBitId)
}