...
)
{
    ...
    fun <T : IPacketMessage> putDecoder(
        opcode: Int,
        decoder: IPacketDecoder<*>,
        listener: IGamePacketListener<*, Player>,
    ...
    fun <T : IPacketMessage> putDecoders(
        vararg opcodes: Int,
        decoder: IPacketDecoder<*>,
        listener: IGamePacketListener<*, Player>,
        packetType: PacketType = PacketType.FIXED,
        ...
        decoders.computeIfAbsent(clazz) {
            ...
            opcodes.forEach { opcode ->
                decoderMap.computeIfAbsent(opcode) {
                    DecodingGamePacketMessage(
                        opcode,
                        decoder,
                        listener,
                        packetType,
