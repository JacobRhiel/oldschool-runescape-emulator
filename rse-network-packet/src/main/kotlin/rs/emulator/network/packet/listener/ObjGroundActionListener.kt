...
import rs.emulator.plugins.extensions.factories.ItemGroundActionFactory
...
class ObjGroundActionListener : GamePacketListener<ObjGroundActionMessage> {
    override fun handle(channel: Channel, player: Player, message: ObjGroundActionMessage) {
