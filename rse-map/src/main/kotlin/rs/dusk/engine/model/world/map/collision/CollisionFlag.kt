...
fun Direction.flag() = when (this) {
    ...
    Direction.SOUTH_EAST -> rs.dusk.engine.model.world.map.collision.CollisionFlag.SOUTH_EAST
    Direction.SOUTH -> rs.dusk.engine.model.world.map.collision.CollisionFlag.SOUTH
    Direction.SOUTH_WEST -> rs.dusk.engine.model.world.map.collision.CollisionFlag.SOUTH_WEST
    Direction.WEST -> rs.dusk.engine.model.world.map.collision.CollisionFlag.WEST
    Direction.NONE -> 0
}