...
class LobbyLogin : LoginActionFactory, LoginAction {
    ...
    override fun onLogin(player: IPlayer) {
        ...
        player.messages().sendSmallVarp(43, 3)
        player.messages().sendSmallVarp(84, 1)
        ...
        player.messages().sendSmallVarp(261, 6)
        ...
        player.messages().sendLargeVarp(477, 1)
        ...
        player.messages().sendSmallVarp(1666, 144)
        ...
        player.messages().sendSmallVarp(1795, 256)
